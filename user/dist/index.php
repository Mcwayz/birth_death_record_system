                ...
                <main>
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            ...
                            <?php
                                $sql = "Select Count(*)AS Male From birth_tbl WHERE birth_gender = 'Male'";
                                $result = mysqli_query($mysqli,$sql);
                                $row = $result->fetch_row();
                                                        {?>
                                <div class="card bg-primary text-white mb-4">
                                    <div class="card-body">Male Births' Recorded</div>
                            ...
                            <div class="col-xl-3 col-md-6">
                            <?php
                                $sql = "Select Count(*)AS Male From birth_tbl WHERE birth_gender = 'Female'";
                                $result = mysqli_query($mysqli,$sql);
                                $row = $result->fetch_row();
                                                        {?>
                                <div class="card bg-warning text-white mb-4">
                                    <div class="card-body">Female Births' Recorded</div>
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white stretched-link" href="viewbirths.php"><?php echo $row[0];?></a>
                                        <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                    </div>
