...
{   
    ...
    $Profile->editUser($id, $fullname, $user_email, $user_role, $usr_pass);
}
?>
                                        ...
                                        <div class="form-row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" name="in_Fullname" id="in_Fullname" type="text" value="<?=$row['fullname']?>" />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" name="in_Email"  id="in_Email" type="text" value="<?=$row['user_email']?>" />
                                                    </div>
                                                 </div>
                                            </div>
                                            ...
                                            <div class="form-row">
                                                <div class="col-md-6">
                                                  <div class="form-group">
                                                        ...
                                                        <select class="form-control" id='in_Role' name='in_Role' >
                                              ...
                                              <div class="col-md-6">
                                                <div class="form-group">
                                                        ...
                                                        <input class="form-control" name="in_Pass" id="in_Pass" type="Text" value="<?=$row['user_password']?>" />
                                                    </div>
                                             </div>
                                                 
                                            </div>
                                            <div class="form-group">
                                                <input class="btn btn-secondary" id="submit" type="submit" name="submit" value="Update Profile">
                                            </div>
                                        </form>
                                    </div>
                                </div>
